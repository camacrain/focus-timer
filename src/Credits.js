...
function Credits() {
    ...
    return (
        <p className={`${styles.credits} ${hasClickedTipLink ? styles.hiddenCredits : ''}`}>Like it? Help me make my first bucks on <a href='#' target='_blank' onClick={() => saveHasClickedLink()}>Gumroad</a>!</p>
    )
}
